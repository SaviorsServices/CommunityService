...
from divulga.models import CommunityAction, HealthService, Establishment, Donation, VoluntaryService
...
def list_all_voluntary(request):
    volunteers = VoluntaryService.objects.all()
    name = "Voluntários"
    return render(
        request,
        'list_search.html',
        {"volunteers": volunteers, "name": name}
        )
