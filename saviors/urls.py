...
urlpatterns = [
    ...
    url(r'^all_services/', views.list_all_services, name='all_services'),
    url(r'^all_donations/', views.list_all_donations, name='all_donations'),
    url(r'^all_establishment/', views.list_all_establishment, name='all_establishment'),
    url(r'^all_voluntary/', views.list_all_voluntary, name='all_voluntary'),
]
